...
function loadProfileDe() {
    ...
    $.getJSON("getAllUsersDe", function (response) {
        $("#sum1p").empty();
        ...
        function gelp(unit) {
            ...
            if (res[0] !== "" && res[1] !== "") {
                var edited = "<a class='list-group-item inactive-link'>\n\
                       <h4 class='list-group-item-heading' style='font-weight: 700;' id='pexh'>\n\
                       " + res[0] + "</h4>\n\
                       <p class='list-group-item-text' style='font-size:13px' id='pexp'>\n\
                       " + res[1] + "</p>\n\
                       </a>";
                $("#pexfu").append(edited);
            }
...
//get all ratings
function abc() {
    $.getJSON("getAllRatings", function (response) {
        var jsona = response;
...
$(".rat1").click(function () {
    ...
    $.getJSON("addRags?id=" + id + "", function (response) {
//        alert(response);
    });
    abc();
});